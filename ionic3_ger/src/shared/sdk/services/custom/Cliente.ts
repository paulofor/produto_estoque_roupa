...
export class ClienteApi extends BaseLoopBackApi {
  ...
  obtemLista(filter: LoopBackFilter = {}, customHeaders?: Function) : Observable<Cliente[]> {
    return of(CLIENTE);
  }
  obtemElemento(filter: LoopBackFilter = {}, customHeaders?: Function) : Observable<Cliente> {
    return of(CLIENTE[filter.where.id]);
  }
